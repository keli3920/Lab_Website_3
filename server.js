...
app.get('/player_info/post', function(req, res) {
  ...
  var query4 = 'select COUNT(*) FROM (SELECT id FROM football_players, football_games WHERE football_players.id = ANY(football_games.players)) AS Tplayers WHERE Tplayers.id = ' + player_choice + ';';
  ...
  .then(data => {
  	res.render('pages/player_info',{
        ...
        player_rushy: data[5],
        player_recy: data[6],
        player_avgPass: data[7],
        player_avgRush: data[8],
        player_avgRec: data[9],
        player_img: data[10],
        players: data[11]
  		})
  })
  .catch(error => {
      // display error message in case an error
          ...
          res.render('pages/player_info/post',{
  			my_title: "Player Info",
        player_name_id: "you are a dumb developer",
        player_year: "you are a dumb developer",
        player_major: "you are a dumb developer",
        player_games: "you are a dumb developer",
        player_passy: "you are a dumb developer",
        player_rushy: "you are a dumb developer",
        player_recy: "you are a dumb developer",
        player_avgPass: "you are a dumb developer",
        player_avgRush: "you are a dumb developer",
        player_avgRec: "you are a dumb developer",
        player_img: "asdasdasd",
        players: "asdasdasd"
  		})
  });
});
